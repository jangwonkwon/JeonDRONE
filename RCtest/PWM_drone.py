...
def main_key_everytime(window):
		...
		curses.halfdelay(1)
                ...
                if key == 49:
                        ...
                        print('2')
                        setMotor(CH1, 12, FORWARD)
                        setMotor(CH2, 12, FORWARD)
                elif key == 51:
                        print('3')
                        setMotor(CH1, 12.1, FORWARD)
			setMotor(CH2, 12.1, FORWARD)
                elif key == 52:
                        print('4')
                        setMotor(CH2, 12.2, FORWARD)
			setMotor(CH2, 12.2, FORWARD)
                elif key ==53:
                        print('5')
                        setMotor(CH1, 12.3, FORWARD)
                        setMotor(CH2, 12.3, FORWARD)
			...
			#curses.halfdelay(1)
			setMotor(CH1, 6, FORWARD)
			setMotor(CH2, 6, FORWARD)

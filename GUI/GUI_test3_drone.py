...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.Motor_pin =18   # pin Number

        self.frequency = 500  # default Frequency
        self.duty = 10        # default duty

        GPIO.setmode(GPIO.BCM)

        #add for multiple motor 
        GPIO.setup(self.Motor_pin, GPIO.OUT)
        self.pwm_led = GPIO.PWM(self.Motor_pin,self.frequency)

        self.pwm_led.start(self.duty)
...
#        print(self.duty)
    ...
    def Frequency_set(self):
        ...
        self.pwm_led.ChangeFrequency(self.frequency)
    def duty_set(self):
        print("duty = "+str(self.duty))
        self.pwm_led.ChangeDutyCycle(self.duty)
